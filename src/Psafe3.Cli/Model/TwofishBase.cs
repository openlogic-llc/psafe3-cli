...
namespace Psafe3.Cli.Model
{
    ...
    internal class TwofishBase
    {
		...
		*
        ...
        #endregion These are all the definitions that were found in AES.H
		...
		***********************************************************************/
        ...
        #endregion These are all the definitions that were found in TABLE.H that we need
        ...
        #endregion These are all the definitions that were found in PLATFORM.H that we need
    }
}